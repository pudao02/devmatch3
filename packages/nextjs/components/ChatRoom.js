...
export default function ChatRoom({ onSend }) {
  ...
  return (
    <div style={{
      ...
      <form onSubmit={handleSend} style={{ display: 'flex', borderTop: '2px solid #b3d1f7', background: '#f5faff', borderBottomLeftRadius: '15px', borderBottomRightRadius: '15px', padding: '10px 14px' }}>
        <input
          type="text"
          value={input}
        ...
        onMouseDown={e => e.target.style.background = '#ffe9b3'}
        onMouseUp={e => e.target.style.background = '#ffe08a'}
        >
          Send
        </button>
      </form>
