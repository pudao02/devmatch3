    ...
    <div style={{ padding: "20px", maxWidth: "1200px", margin: "0 auto" }}>
      ...
      >
        ...
        <p style={{ color: "#666", marginBottom: "15px" }}>
          Ask healthcare questions and get AI-powered responses. All conversations are stored securely on the Oasis
          Sapphire blockchain using confidential storage. Powered by TEST ROSE tokens.
        </p>
        {!address && (
          <div
            style={{
